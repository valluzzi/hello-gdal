INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDataTypeUnion
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDataTypeSize
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDataTypeIsComplex
  INTEGER(kind=c_int),VALUE :: edatatype ! GDALDataType
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDataTypeName
  INTEGER(kind=c_int),VALUE :: edatatype ! GDALDataType
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDataTypeByName
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetPaletteInterpretationName
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetColorInterpretationName
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetColorInterpretationByName
  CHARACTER(kind=c_char),INTENT(in) :: pszname(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALIdentifyDriver
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALOpenShared
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
  INTEGER(kind=c_int),VALUE :: eaccess ! GDALAccess
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDriverCount
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDestroyDriver
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALRegisterDriver
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDeregisterDriver
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDeleteDataset
  TYPE(gdaldriverh),VALUE :: hdriver
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALRenameDataset
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCopyDatasetFiles
  TYPE(gdaldriverh),VALUE :: hdriver
  CHARACTER(kind=c_char),INTENT(in) :: psznewname(*)
  CHARACTER(kind=c_char),INTENT(in) :: pszoldname(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALValidateCreationOptions
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDriverShortName
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDriverLongName
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDriverHelpTopic
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDriverCreationOptionList
  TYPE(gdaldriverh),VALUE :: hdriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALInvGeoTransform
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDatasetDriver
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetFileList
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterCount
  TYPE(gdaldataseth),VALUE :: hdataset
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALAddBand
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALBeginAsyncReader
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALEndAsyncReader
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDatasetAdviseRead
  TYPE(gdaldataseth),VALUE :: hds
  INTEGER(kind=c_int),VALUE :: ndsxoff
  INTEGER(kind=c_int),VALUE :: ndsyoff
  INTEGER(kind=c_int),VALUE :: ndsxsize
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetGCPCount
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetGCPProjection
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetInternalHandle
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALReferenceDataset
  TYPE(gdaldataseth),VALUE :: hdataset
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDereferenceDataset
  TYPE(gdaldataseth),VALUE :: hdataset
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALBuildOverviews
  TYPE(gdaldataseth),VALUE :: hdataset
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetOpenDatasets
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetAccess
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALFlushCache
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCreateDatasetMaskBand
  TYPE(gdaldataseth),VALUE :: hds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDatasetCopyWholeRaster
  TYPE(gdaldataseth),VALUE :: hsrcds
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALRasterBandCopyWholeRaster
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALRegenerateOverviews
  TYPE(gdalrasterbandh),VALUE :: hsrcband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALRasterAdviseRead
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterBandXSize
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterBandYSize
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterAccess
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetBandNumber
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetBandDataset
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterColorInterpretation
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetRasterColorInterpretation
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterColorTable
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetRasterColorTable
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALHasArbitraryOverviews
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetOverviewCount
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetOverview
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterCategoryNames
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterStatistics
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALComputeRasterStatistics
  TYPE(gdalrasterbandh),VALUE :: hband
  INTEGER(kind=c_int),VALUE :: bapproxok
  REAL(kind=c_double) :: pdfmin(*)
  REAL(kind=c_double) :: pdfmax(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetRasterStatistics
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterUnitType
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetRasterUnitType
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterOffset
  TYPE(gdalrasterbandh),VALUE :: hband
  INTEGER(kind=c_int),INTENT(inout) :: pbsuccess
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetRasterOffset
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterScale
  TYPE(gdalrasterbandh),VALUE :: hband
  INTEGER(kind=c_int),INTENT(inout) :: pbsuccess
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetRasterScale
  TYPE(gdalrasterbandh),VALUE :: hband
  REAL(kind=c_double),VALUE :: dfnewoffset
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALComputeRasterMinMax
  TYPE(gdalrasterbandh),VALUE :: hband
  INTEGER(kind=c_int),VALUE :: bapproxok
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALFlushRasterCache
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterHistogram
  TYPE(gdalrasterbandh),VALUE :: hband
  REAL(kind=c_double),VALUE :: dfmin
  REAL(kind=c_double),VALUE :: dfmax
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDefaultHistogram
  TYPE(gdalrasterbandh),VALUE :: hband
  REAL(kind=c_double) :: pdfmin(*)
  REAL(kind=c_double) :: pdfmax(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetDefaultHistogram
  TYPE(gdalrasterbandh),VALUE :: hband
  REAL(kind=c_double),VALUE :: dfmin
  REAL(kind=c_double),VALUE :: dfmax
  INTEGER(kind=c_int),VALUE :: nbuckets
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRandomRasterSample
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetRasterSampleOverview
  TYPE(gdalrasterbandh),VALUE :: hband
  TYPE(c_ptr),VALUE :: t
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALFillRaster
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALComputeBandStats
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALOverviewMagnitudeCorrection
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetDefaultRAT
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetDefaultRAT
  TYPE(gdalrasterbandh),VALUE :: hband
  TYPE(c_ptr),VALUE :: h
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALAddDerivedBandPixelFunc
  CHARACTER(kind=c_char),INTENT(in) :: pszname(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetMaskBand
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetMaskFlags
  TYPE(gdalrasterbandh),VALUE :: hband
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCreateMaskBand
  TYPE(gdalrasterbandh),VALUE :: hband
  INTEGER(kind=c_int),VALUE :: nflags
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALARGetNextUpdatedRegion
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALARLockBuffer
  TYPE(c_ptr),VALUE :: hario
  REAL(kind=c_double),VALUE :: dftimeout
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALARUnlockBuffer
  TYPE(c_ptr),VALUE :: hario
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSwapWords
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCopyWords
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCopyBits
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALLoadWorldFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALReadWorldFile
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALWriteWorldFile
  CHARACTER(kind=c_char),INTENT(in) :: pszbasefilename(*)
  CHARACTER(kind=c_char),INTENT(in) :: pszextension(*)
  REAL(kind=c_double) :: padfgeotransform(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALLoadOziMapFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
  REAL(kind=c_double) :: padfgeotransform(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALReadOziMapFile
  CHARACTER(kind=c_char),INTENT(in) :: pszbasefilename(*)
  REAL(kind=c_double) :: padfgeotransform(*)
  TYPE(c_ptr),VALUE :: ppszwkt ! TYPE(c_ptr_ptr)
  INTEGER(kind=c_int) :: pngcpcount(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALLoadTabFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
  REAL(kind=c_double) :: padfgeotransform(*)
  TYPE(c_ptr),VALUE :: ppszwkt ! TYPE(c_ptr_ptr)
  INTEGER(kind=c_int) :: pngcpcount(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALReadTabFile
  CHARACTER(kind=c_char),INTENT(in) :: pszbasefilename(*)
  REAL(kind=c_double) :: padfgeotransform(*)
  TYPE(c_ptr),VALUE :: ppszwkt ! TYPE(c_ptr_ptr)
  INTEGER(kind=c_int) :: pngcpcount(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALLoadRPBFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALLoadRPCFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
  TYPE(c_ptr),VALUE :: papszsiblingfiles ! TYPE(c_ptr_ptr)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALWriteRPBFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
  TYPE(c_ptr),VALUE :: papszmd ! TYPE(c_ptr_ptr)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALLoadIMDFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
  TYPE(c_ptr),VALUE :: papszsiblingfiles ! TYPE(c_ptr_ptr)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALWriteIMDFile
  CHARACTER(kind=c_char),INTENT(in) :: pszfilename(*)
  TYPE(c_ptr),VALUE :: papszmd ! TYPE(c_ptr_ptr)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDecToDMS
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALPackedDMSToDec
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDecToPackedDMS
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALExtractRPCInfo
  TYPE(c_ptr),VALUE :: papszmd ! TYPE(c_ptr_ptr)
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCreateColorTable
  INTEGER(kind=c_int),VALUE :: einterp ! GDALPaletteInterp
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALDestroyColorTable
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCloneColorTable
  TYPE(gdalcolortableh),VALUE :: htable
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetPaletteInterpretation
  TYPE(gdalcolortableh),VALUE :: htable
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetColorEntryCount
  TYPE(gdalcolortableh),VALUE :: htable
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetColorEntry
  TYPE(gdalcolortableh),VALUE :: htable
  INTEGER(kind=c_int),VALUE :: i
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetColorEntryAsRGB
  TYPE(gdalcolortableh),VALUE :: htable
  INTEGER(kind=c_int),VALUE :: i
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetColorEntry
  TYPE(gdalcolortableh),VALUE :: htable
  INTEGER(kind=c_int),VALUE :: i
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALCreateColorRamp
  TYPE(gdalcolortableh),VALUE :: htable
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetCacheMax
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetCacheMax
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetCacheUsed
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALSetCacheMax64
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetCacheMax64
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALGetCacheUsed64
...
INTERFACE
  ...
  IMPORT
!!DEC$ ATTRIBUTES STDCALL :: GDALFlushCacheBlock
